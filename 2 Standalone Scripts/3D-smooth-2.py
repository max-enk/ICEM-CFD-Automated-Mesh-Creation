...
name_gwall = "GASWALL"
name_gtop = "GASTOP"
name_distr_bot = "DISTRIBUTORBOTTOM"
name_distr_wall = "DISTRIBUTORWALL"
name_sides = "SIDES"
...
meshtype = "3D-smooth-1"        # 3D smooth mesh without structures
...
print("#################################################################### WELCOME ####################################################################\n")
print("This is a script for the automatic generation of a 3D smooth mesh in ICEM. Features:\n    - additional gas space above film inlet\n    - shared outlet for gas and liquid phases")
        ...
        while True:
            ...
            if os.path.exists(refconffile):
                ...
                if dimmode == True:
                    ...
                    print("The config file specified is not suited for 3D smooth mesh creation.")
            else:
...
geom_distr_bot = []                         # list of surfaces included in distributor bottom
geom_distr_wall = []                        # list of surfaces included in distributor wall
geom_sides = []                             # list of surfaces included in sides

# points
pnts.append(Point(0.0, 0.0, 0.0))
pnts.append(Point(0.0, 0.0, w_s1.getval()))
pnts.append(Point(0.0, 0.0, (w_s1.getval() + w_c.getval())))
pnts.append(Point(0.0, 0.0, w_t.getval()))
pnts.append(Point(0.0, l_t.getval(), w_t.getval()))
pnts.append(Point(0.0, l_t.getval(), (w_s1.getval() + w_c.getval())))
pnts.append(Point(0.0, l_t.getval(), w_s1.getval()))
pnts.append(Point(0.0, l_t.getval(), 0.0))
pnts.append(Point(h_nu.getval(), l_t.getval(), 0.0))
pnts.append(Point(h_nu.getval(), l_t.getval(), w_s1.getval()))
pnts.append(Point(h_nu.getval(), l_t.getval(), (w_s1.getval() + w_c.getval())))
pnts.append(Point(h_nu.getval(), l_t.getval(), w_t.getval()))
pnts.append(Point(h_nu.getval(), 0.0, w_t.getval()))
pnts.append(Point(h_nu.getval(), 0.0, (w_s1.getval() + w_c.getval())))
pnts.append(Point(h_nu.getval(), 0.0, w_s1.getval()))
pnts.append(Point(h_nu.getval(), 0.0, 0.0))
pnts.append(Point((h_nu.getval() + h_d.getval()), 0.0, 0.0))
pnts.append(Point((h_nu.getval() + h_d.getval()), 0.0, w_s1.getval()))
pnts.append(Point((h_nu.getval() + h_d.getval()), 0.0, (w_s1.getval() + w_c.getval())))
pnts.append(Point((h_nu.getval() + h_d.getval()), 0.0, w_t.getval()))
pnts.append(Point((h_nu.getval() + h_d.getval()), l_t.getval(), w_t.getval()))
pnts.append(Point((h_nu.getval() + h_d.getval()), l_t.getval(), (w_s1.getval() + w_c.getval())))
pnts.append(Point((h_nu.getval() + h_d.getval()), l_t.getval(), w_s1.getval()))
...
pnts.append(Point((h_nu.getval() + h_d.getval()), (l_t.getval() + l_g.getval()), w_s1.getval()))
pnts.append(Point((h_nu.getval() + h_d.getval()), (l_t.getval() + l_g.getval()), (w_s1.getval() + w_c.getval())))
pnts.append(Point((h_nu.getval() + h_d.getval()), (l_t.getval() + l_g.getval()), w_t.getval()))
pnts.append(Point(h_t.getval(), (l_t.getval() + l_g.getval()), w_t.getval()))
pnts.append(Point(h_t.getval(), (l_t.getval() + l_g.getval()), (w_s1.getval() + w_c.getval())))
pnts.append(Point(h_t.getval(), (l_t.getval() + l_g.getval()), w_s1.getval()))
pnts.append(Point(h_t.getval(), (l_t.getval() + l_g.getval()), 0.0))
pnts.append(Point(h_t.getval(), l_t.getval(), 0.0))
pnts.append(Point(h_t.getval(), l_t.getval(), w_s1.getval()))
pnts.append(Point(h_t.getval(), l_t.getval(), (w_s1.getval() + w_c.getval())))
pnts.append(Point(h_t.getval(), l_t.getval(), w_t.getval()))
pnts.append(Point(h_t.getval(), 0.0, w_t.getval()))
pnts.append(Point(h_t.getval(), 0.0, (w_s1.getval() + w_c.getval())))
pnts.append(Point(h_t.getval(), 0.0, w_s1.getval()))
pnts.append(Point(h_t.getval(), 0.0, 0.0))
print(" - done points")

# curves
crvs.append(Curve(pnts[35], pnts[32]))
crvs.append(Curve(pnts[28], pnts[31]))
crvs.append(Curve(pnts[27], pnts[24]))
crvs.append(Curve(pnts[24], pnts[31]))
crvs.append(Curve(pnts[27], pnts[28]))
crvs.append(Curve(pnts[20], pnts[35]))
crvs.append(Curve(pnts[23], pnts[32]))
crvs.append(Curve(pnts[20], pnts[23]))
crvs.append(Curve(pnts[20], pnts[11]))
crvs.append(Curve(pnts[11], pnts[4]))
crvs.append(Curve(pnts[4], pnts[7]))
crvs.append(Curve(pnts[7], pnts[8]))
crvs.append(Curve(pnts[8], pnts[23]))
crvs.append(Curve(pnts[8], pnts[11]))
crvs.append(Curve(pnts[20], pnts[27]))
crvs.append(Curve(pnts[35], pnts[28]))
crvs.append(Curve(pnts[23], pnts[24]))
crvs.append(Curve(pnts[32], pnts[31]))
crvs.append(Curve(pnts[36], pnts[39]))
crvs.append(Curve(pnts[16], pnts[19]))
crvs.append(Curve(pnts[12], pnts[15]))
crvs.append(Curve(pnts[0], pnts[3]))
crvs.append(Curve(pnts[3], pnts[12]))
crvs.append(Curve(pnts[12], pnts[19]))
crvs.append(Curve(pnts[19], pnts[36]))
crvs.append(Curve(pnts[0], pnts[15]))
crvs.append(Curve(pnts[15], pnts[16]))
crvs.append(Curve(pnts[16], pnts[39]))
crvs.append(Curve(pnts[36], pnts[35]))
crvs.append(Curve(pnts[3], pnts[4]))
crvs.append(Curve(pnts[0], pnts[7]))
crvs.append(Curve(pnts[39], pnts[32]))
crvs.append(Curve(pnts[11], pnts[12]))
crvs.append(Curve(pnts[19], pnts[20]))
crvs.append(Curve(pnts[16], pnts[23]))
crvs.append(Curve(pnts[8], pnts[15]))
print(" - done curves")

# surfaces
srfs.append(Surf("2-4crvs", [crvs[21], crvs[20], crvs[22], crvs[25]]))
geom_foutlet.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[20], crvs[19], crvs[26], crvs[23]]))
geom_foutlet.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[24], crvs[18], crvs[27], crvs[19]]))
geom_foutlet.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[25], crvs[30], crvs[35], crvs[11]]))
geom_sides.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[12], crvs[34], crvs[35], crvs[26]]))
geom_sides.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[27], crvs[34], crvs[31], crvs[6]]))
geom_sides.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[6], crvs[17], crvs[3], crvs[16]]))
geom_sides.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[9], crvs[29], crvs[32], crvs[22]]))
geom_sides.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[8], crvs[32], crvs[33], crvs[23]]))
geom_sides.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[5], crvs[33], crvs[24], crvs[28]]))
geom_sides.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[14], crvs[4], crvs[5], crvs[15]]))
geom_sides.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[0], crvs[1], crvs[17], crvs[15]]))
geom_gwall.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[7], crvs[2], crvs[14], crvs[16]]))
geom_distr_wall.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[3], crvs[2], crvs[1], crvs[4]]))
geom_gtop.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[7], crvs[13], crvs[12], crvs[8]]))
geom_distr_bot.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[9], crvs[10], crvs[13], crvs[11]]))
geom_finlet.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[10], crvs[30], crvs[29], crvs[21]]))
geom_fwall.append(srfs[-1])
srfs.append(Surf("2-4crvs", [crvs[18], crvs[31], crvs[28], crvs[0]]))
geom_gwall.append(srfs[-1])
print(" - done surfaces\n")
...
prts.append(Part(name_distr_bot , geom_distr_bot))
prts.append(Part(name_distr_wall , geom_distr_wall))
...
blkg.append(Split(pnts[35], 38, 42))
blkg.append(Split(pnts[20], 73, 74))
blkg.append(Delete(31))
blkg.append(Split(pnts[11], 73, 92))
blkg.append(Split(pnts[34], 70, 74))
blkg.append(Split(pnts[33], 70, 136))
print(" - done\n")

# vertex-point associations
print("Associating vertices to points...")
verts.append(Vert(73, pnts[4]))
verts.append(Vert(112, pnts[11]))
verts.append(Vert(92, pnts[20]))
verts.append(Vert(93, pnts[27]))
verts.append(Vert(42, pnts[28]))
verts.append(Vert(74, pnts[35]))
verts.append(Vert(133, pnts[5]))
verts.append(Vert(134, pnts[10]))
verts.append(Vert(135, pnts[21]))
verts.append(Vert(141, pnts[26]))
verts.append(Vert(142, pnts[29]))
verts.append(Vert(136, pnts[34]))
verts.append(Vert(163, pnts[6]))
verts.append(Vert(164, pnts[9]))
verts.append(Vert(165, pnts[22]))
verts.append(Vert(171, pnts[25]))
verts.append(Vert(172, pnts[30]))
verts.append(Vert(166, pnts[33]))
verts.append(Vert(69, pnts[7]))
verts.append(Vert(107, pnts[8]))
verts.append(Vert(87, pnts[23]))
verts.append(Vert(88, pnts[24]))
verts.append(Vert(41, pnts[31]))
verts.append(Vert(70, pnts[32]))
verts.append(Vert(38, pnts[36]))
verts.append(Vert(91, pnts[19]))
verts.append(Vert(111, pnts[12]))
verts.append(Vert(22, pnts[3]))
verts.append(Vert(127, pnts[2]))
verts.append(Vert(128, pnts[13]))
verts.append(Vert(129, pnts[18]))
verts.append(Vert(130, pnts[37]))
verts.append(Vert(157, pnts[1]))
verts.append(Vert(158, pnts[14]))
verts.append(Vert(159, pnts[17]))
verts.append(Vert(160, pnts[38]))
verts.append(Vert(21, pnts[0]))
verts.append(Vert(106, pnts[15]))
verts.append(Vert(86, pnts[16]))
verts.append(Vert(37, pnts[39]))
print(" - done\n")
...
# x-coordinate
mshg.append(Mesh(73, 112, h_nu.getmesh()))  # film inlet
mshg.append(Mesh(112, 92, h_d.getmesh()))   # distributor
mshg.append(Mesh(92, 74, h_g.getmesh()))    # gas space
# y-coordinate
mshg.append(Mesh(38, 74, l_t.getmesh()))    # total domain size 
mshg.append(Mesh(42, 74, l_g.getmesh()))    # additional gas space
# z-coordinate
mshg.append(Mesh(37, 160, w_s1.getmesh()))  # side section 1 (closer to coordinate origin)
mshg.append(Mesh(160, 130, w_c.getmesh()))  # center section
mshg.append(Mesh(130, 38, w_s2.getmesh()))  # side section 2
print(" - done\n")
...
# add lines for vertex associations
for vert in verts:
